<?php 
include('../path.php');
//$addApp->controllers('blog.php');
$page = 'blog';
?>
<!DOCTYPE html>
<html dir="ltr" lang="en-US">
<?php $addApp->includes('open/links_top.php', ''); ?>
						...
						<div class="single-post nobottommargin">
							...
							<div class="entry clearfix">
								...
								<div class="entry-image">
									<a href="#"><img src="<?php echo BASE_URL . '/assets/open/'?>images/blog/full/1.jpg" alt="Blog Single"></a>
								</div><!-- .entry-image end -->
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="author-image">
										<img src="<?php echo BASE_URL . '/assets/open/'?>images/author/1.jpg" alt="" class="rounded-circle">
									</div>
							...
							<div class="related-posts clearfix">
								...
								<div class="col_half nobottommargin">
									...
									<div class="mpost clearfix">
										<div class="entry-image">
											<a href="#"><img src="<?php echo BASE_URL . '/assets/open/'?>images/blog/small/10.jpg" alt="Blog Single"></a>
										</div>
										<div class="entry-c">
											<div class="entry-title">
									...
									<div class="mpost clearfix">
										<div class="entry-image">
											<a href="#"><img src="<?php echo BASE_URL . '/assets/open/'?>images/blog/small/20.jpg" alt="Blog Single"></a>
										</div>
										<div class="entry-c">
											<div class="entry-title">
								...
								<div class="col_half nobottommargin col_last">
									...
									<div class="mpost clearfix">
										<div class="entry-image">
											<a href="#"><img src="<?php echo BASE_URL . '/assets/open/'?>images/blog/small/21.jpg" alt="Blog Single"></a>
										</div>
										<div class="entry-c">
											<div class="entry-title">
									...
									<div class="mpost clearfix">
										<div class="entry-image">
											<a href="#"><img src="<?php echo BASE_URL . '/assets/open/'?>images/blog/small/22.jpg" alt="Blog Single"></a>
										</div>
										<div class="entry-c">
											<div class="entry-title">
									...
									<div class="tab-container">
										...
										<div class="tab-content clearfix" id="tabs-1">
											<div id="popular-post-list-sidebar">
												...
												<div class="spost clearfix">
													<div class="entry-image">
														<a href="#" class="nobg"><img class="rounded-circle" src="<?php echo BASE_URL . '/assets/open/'?>images/magazine/small/3.jpg" alt=""></a>
													</div>
													<div class="entry-c">
														<div class="entry-title">
												...
												<div class="spost clearfix">
													<div class="entry-image">
														<a href="#" class="nobg"><img class="rounded-circle" src="<?php echo BASE_URL . '/assets/open/'?>images/magazine/small/2.jpg" alt=""></a>
													</div>
													<div class="entry-c">
														<div class="entry-title">
												...
												<div class="spost clearfix">
													<div class="entry-image">
														<a href="#" class="nobg"><img class="rounded-circle" src="<?php echo BASE_URL . '/assets/open/'?>images/magazine/small/1.jpg" alt=""></a>
													</div>
													<div class="entry-c">
														<div class="entry-title">
										...
										<div class="tab-content clearfix" id="tabs-3">
											<div id="recent-post-list-sidebar">
												...
												<div class="spost clearfix">
													<div class="entry-image">
														<a href="#" class="nobg"><img class="rounded-circle" src="<?php echo BASE_URL . '/assets/open/'?>images/icons/avatar.jpg" alt=""></a>
													</div>
													<div class="entry-c">
									...
									<div class="oc-item">
										<div class="iportfolio">
											<div class="portfolio-image">
												...
												<div class="portfolio-overlay">
													<a href="<?php echo BASE_URL . '/assets/open/'?>images/blog/full/1.jpg" class="center-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
												</div>
											</div>
											<div class="portfolio-desc center nobottompadding">
